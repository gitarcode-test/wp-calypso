...
productionConfig.features.is_running_in_blaze_plugin = true;
...
productionConfig.features.blaze_setup_mode = true;
...
const dashboardPathPrefix = window.configData?.dashboard_path_prefix || '/wc-blaze';
